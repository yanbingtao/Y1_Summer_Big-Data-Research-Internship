...
prov="上海市"
citiesInProv=["上海市"]
fileNameList = [path+'\历史天气_5.csv',path+'\历史天气_12.csv']
# prov="北京市"
# citiesInProv=["北京市"]
# fileNameList = [path+'\历史天气_0.csv']
# prov="天津市"
# citiesInProv=["天津市"]
# fileNameList = [path+'\历史天气_6.csv',path+'\历史天气_13.csv']
# prov="澳门特别行政区"
# citiesInProv=["澳门特别行政区"]
# fileNameList = [path+'\历史天气_0.csv']
# prov="重庆市"
# citiesInProv=["重庆市"]
# fileNameList = [path+'\历史天气_7.csv',path+'\历史天气_15.csv']
# prov="香港特别行政区"
# citiesInProv=["香港特别行政区"]
# fileNameList = [path+'\历史天气_6.csv',path+'\历史天气_13.csv']
